...
def your_name():
    '''returns users input'''
    name = name_entry.get()
    title_label = ctk.CTkLabel(root, text=f"{name}'s Daily Planner" , font=ctk.CTkFont(size=30, weight="bold"))
...
quotes = [
        ...
        "Heroes are made in the hour of defeat. Success is merely the ashes of their endeavors. \n\t Batman"
        "You only have your thoughts and dreams ahead of you. You are someone. You mean something. \n\t Batman"
...
def add_emotion():
    '''adds the entered emotion to the list and displays it in task_frame2'''
